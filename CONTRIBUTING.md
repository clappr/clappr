...
- Sourcemaps: an artifact in `dist/` gets a map iff it is a package/`exports` entry, a documented consumer entry point, or minified — see [Releasing → Sourcemaps](./.github/RELEASING.md#sourcemaps).
