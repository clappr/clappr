(function (global, factory) {
  ...
  */
  ...
  var VERSION_REGEX = /*#__PURE__*/_wrapRegExp(/([0-9]+)(\.([0-9]+)?(\.([0-9]+))?)?/, {
    major: 1,
    minor: 3,
    patch: 5
  });
  ...
  var Version = /*#__PURE__*/function () {
    _createClass(Version, null, [{
      ...
      value: function parse() {
        ...
        var _ref = str.match(VERSION_REGEX) || {},
            groups = _ref.groups;
  ...
  // Copyright 2014 Globo.com Player authors. All rights reserved.
  var version = "0.4.10"; // Built-in Plugins/Playbacks
