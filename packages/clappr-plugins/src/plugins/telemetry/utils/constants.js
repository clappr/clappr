...
/**
 * Generic source identifier for network adapter telemetry.
 * Used across all player implementations to maintain abstraction.
 */
export const TELEMETRY_SOURCE_NETWORK = 'network'
