...
export default class Player extends BaseObject {
   ...
   * define a custom internal plugins set {playback: ['pluginName1', ...], container: ['pluginName1', ...], core: ['pluginName1', ...]}. Override global Clappr.interlalPlugins default set.
   * @param {Object} [options.plugins]
   * define a custom external plugin set {playback: [pluginClass1, ...], container: [pluginClass1', ...], core: [pluginClass1, ...]}.
   */
  constructor(options) {
    super(options)
